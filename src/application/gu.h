...
#define GU_H_
     ...
     enum {/*switch*/amp = 0,cab,eq,deley,phas,fl,chor,early,reve,trem,pream,gate,compr,moog,
    	 /*cab_mono*/cab_m = 41,
    	 /*cab*/vol,cab1_pan,cab1_del,cab2_vol,cab2_pan,cab2_del,
    	 /*eq*/eq1,eq2,eq3,eq4,eq5,
    	 /*lpf_hpf_pres*/hpf_v,lpf_v,pre_v,
		 /*phas*/phaser_vol,phaser_rate,phaser_white,phaser_center,phaser_fed,phaser_type,
       ...
       /*early refl*/early_vol,early_type,/*eq_b_f*/f1,f2,f3,f4,f5,/*eq_b_q*/q1,q2,q3,q4,q5,
       ...
       /*del_tap*/d_tap_t,/*tremolo_tap*/t_tap_t,
       /*moog*/mog_vol,mog_type,mog_mod,mog_rate,mog_lo,mog_hi,mog_res,mog_th,mog_at,mog_re,mog_vo,mog_ext,
