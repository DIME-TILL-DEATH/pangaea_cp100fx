...
//-------------------------------------------------Reverb---------------------------------------------
		...
		break;
//-------------------------------------------------Tremolo--------------------------------------------
		case Controller::Dst::TremoloOnOff: UITask->setParam(tremolo_on_handler, (val < 64.0f) ? 0 : 1); break;
		case Controller::Dst::TremoloIntensity: UITask->setParam(tremolo_intensity_handler, val); break;
		case Controller::Dst::TremoloRate: UITask->setParam(tremolo_rate_handler, val); break;
...
//-------------------------------------------------------------------------------------------------------------------
		...
		case Controller::Dst::GateOnOff: UITask->setParam(gate_on_handler, (val < 64.0f) ? 0 : 1); break;
		case Controller::Dst::GateThresh: UITask->setParam(gate_threshold_handler, val); break;
