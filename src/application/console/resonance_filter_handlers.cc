...
{
	default_param_handler(&currentPreset.modulesBuf[moog], rl, args, count);
...
static void rf_mix_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_MIX_POS, currentPreset.modulesBuf[RFILTER_MIX]);
}
...
static void rf_filter_type_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_FTYPE_POS, currentPreset.modulesBuf[RFILTER_FTYPE]);
}
...
static void rf_fmod_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_FMOD_POS, currentPreset.modulesBuf[RFILTER_FMOD]);
}
...
static void rf_lpf_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_LPF_POS, currentPreset.modulesBuf[RFILTER_LPF]);
}
...
static void rf_hpf_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_HPF_POS, currentPreset.modulesBuf[RFILTER_HPF]);
}
...
static void rf_resonance_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_RESONANCE_POS, currentPreset.modulesBuf[RFILTER_RESONANCE]);
}
...
static void rf_dyn_threshold_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_DYN_THRESHOLD_POS, currentPreset.modulesBuf[RFILTER_DYN_THRESHOLD]);
}
...
static void rf_dyn_attack_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_DYN_ATTACK_POS, currentPreset.modulesBuf[RFILTER_DYN_ATTACK]);
}
...
static void rf_dyn_release_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFLITER_DYN_RELEASE_POS, currentPreset.modulesBuf[RFLITER_DYN_RELEASE]);
}
...
static void rf_volume_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_VOLUME_POS, currentPreset.modulesBuf[RFILTER_VOLUME]);
}
...
static void rf_lfo_type_command_handler(TReadLine* rl, TReadLine::const_symbol_type_ptr_t* args, const size_t count)
{
	...
	DSP_ContrSendParameter(DSP_ADDRESS_RESONANCE_FILTER, RFILTER_LFO_TYPE_POS, currentPreset.modulesBuf[RFILTER_LFO_TYPE]);
}
