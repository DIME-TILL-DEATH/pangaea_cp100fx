...
public:
	...
	void (*increaseFunctionCallback)(void *valuePtr){nullptr};
	void (*decreaseFunctionCallback)(void *valuePtr){nullptr};
	uint32_t (*valueFunctionCallback)(void *valuePtr){nullptr};

	void (*encoderPress)(void* parameter){nullptr};
