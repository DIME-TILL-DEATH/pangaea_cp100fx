...
void USBD_USR_DeviceReset (uint8_t speed)
{
 /*switch (speed)
 {
   case USB_OTG_SPEED_HIGH:
     { msg ("     USB Device Library v1.1.0  [HS]" ); }
     break;

  case USB_OTG_SPEED_FULL:
     { msg ("     USB Device Library v1.1.0  [FS]" ); }
     break;
 default:
	 { msg ("     USB Device Library v1.1.0  [??]" ); }
 }*/
